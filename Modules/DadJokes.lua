...
local defaultJokes = {
    ...
    "My spouse said 'Buy a gallon of milk, if there are apples, buy 12.' I came home with 12 gallons of milk. There were apples.",
    ...
    "I used to be addicted to elevators. Now I'm taking steps to avoid them.",
    ...
    "What do you call a psychic gnome who escapes from jail? A small medium at large",
    ...
    "My buddy found a suitcase with four kittens in the woods. 'Are they moving?' they asked. 'Not sure,' he said, 'but that would explain the suitcase.'",
    ...
    "Why does it take longer to get from 2nd to 3rd base than from 1st to 2nd? Because there's a Shortstop in between!",
